...
function hero() {
  return (
    ...
    <div className='max-w-7xl mx-auto sm:pl-7'>
        ...
        <div className='sm:flex sm:justify-between pt-20 md:pt-36 sm:mt-10'>
...
<div className="my-auto">
        ...
        <Link href='#subHeroFood'><p className='md:text-lg sm:ml-7 max-w-lg px-5 sm:px-0 sm:flex sm:justify-start mt-3 sm:mt-0 text-center sm:text-left transition duration-300 group transform hover:-translate-y-1 hover:shadow-2xl cursor-pointer text-pink text-xl font-extralight'>See more</p></Link>
        </div>
