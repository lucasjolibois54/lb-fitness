...
<div className="mx-auto">
  <div className="grid sm:grid-cols-3 gap-2 sm:grid-flow-row grid-">
    ...
    <Link href='/articles/benefitsOfHIIT'><img alt="Image" className='w-full cursor-pointer' src='https://res.cloudinary.com/dckwf6med/image/upload/v1661808957/Web%20Dev%20Projects/image_61_1_k3629a.webp'/></Link>
    <p className='mt-5 text-left text-gray-subtext text-sm px-2 font-extralight'>HIIT training is a perfect way not only to burn calories, but also to burn fat. After your workout, all of that intense ...</p>
    <Link href='/articles/benefitsOfHIIT'><p className='cursor-pointer mt-2 text-left text-pink text-sm px-2 font-extralight'>Read more</p></Link>
    </div>
