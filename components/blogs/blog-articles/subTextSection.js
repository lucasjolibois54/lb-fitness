...
function subTextSection(props) {
  return (
    ...
    <h1 className='sm:ml-7 max-w-4xl text-left !leading-tight mt-20 text-white text-4xl xsm:text-3xl sm:text-4xl md:6xl md-lg:text-5xl lg:text-4xl font-semibold '>{props.title}</h1>
