...
function textSection(props) {
  return (
    ...
    <div className='max-w-4xl mx-auto'>
            <div className='mt-20 3xl:mt-28 mr-7 ml-7'>
    ...
    <p className='md:text-lg sm:ml-7 sm:mt-8 max-w-3xl mt-6 text-left text-gray-subtext font-extralight'>{props.paragraph}</p>    </div>
    </div>
    </>
  )
}
