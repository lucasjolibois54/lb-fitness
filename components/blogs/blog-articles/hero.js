...
function hero(props) {
  return (
    ...
    <Link href='/blogs'><img className=' cursor-pointer w-12 sm:w-16 ml-3' src='https://res.cloudinary.com/dckwf6med/image/upload/v1662136014/Web%20Dev%20Projects/Frame_ogtaop.svg'/></Link>
    ...
    <img className='w-screen mt-7 sm:mt-16' src={props.image}/>
    </>
  )
}
