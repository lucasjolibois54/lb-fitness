  ...
  return (
    <>
      <div className="max-w-6xl mx-auto relative z-50 mt-36 sm:mt-28 md:pt-20">
        ...
        <div className="mouse_scroll pt-20 md:pt-20">
      ...
      <img alt="Image" className="absolute top-0" src="https://res.cloudinary.com/dckwf6med/image/upload/v1661523827/Web%20Dev%20Projects/Ellipse-100-_1__jahl4k.webp"/>
    </>
  );
}
