...
const HeaderAuth = () => { 
  return (
    ...
    <div className="block">
    <p className='z-50 float-right mx-7 ml-0 mr-16 text-sm semixsm:text-md semixsm:mr-16 sm:mr-20 -mb-7 mt-5 sm:mt-12 text-pink py-2 px-5 semixsm:px-10 rounded-full border-gray-stroke border-2 cursor-pointer'><Link  href="/api/auth/logout">Logout</Link></p>
    <Nav/>
    </div> </div></div>
  )
}
...
const Header = () => {      // variable with the component Header. () => means it's a function
  return (
   /* <div className=' zzz max-w-7xl mx-auto font-bold'>
    ...
    <div className="block">
    <p className='z-50 float-right mx-7 ml-0 mr-16 text-sm semixsm:text-md semixsm:mr-16 sm:mr-20 -mb-7 mt-5 sm:mt-12 text-pink py-2 px-5 semixsm:px-10 rounded-full border-gray-stroke border-2 cursor-pointer'><Link  href="/api/auth/login">Login</Link></p>
    <Nav/>
    </div> </div></div>
  )
}
