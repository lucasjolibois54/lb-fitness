...
function headerAfterLogin() {
    return (
      <div className=' zzz max-w-7xl mx-auto font-bold'>
        ...
        <Link className='float-right mx-7 -mb-7 mt-12 text-pink py-2 px-10 rounded-full border-gray-stroke border-2 cursor-pointer' href="/membersonly/introduction">See Intro</Link>
        </div> </div></div>
    )
  }
